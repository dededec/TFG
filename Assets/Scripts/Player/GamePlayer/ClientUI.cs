...
- Barra Vida -> Imagen y Escalarla según nivel de vida?
    Igualmente mirar video de la muchacha de los números
- Número en barra de vida
- Barra Maná
- Número en barra de maná

- Cositas de hechizos que ya vendrán *emoji de cohete*

- Número de jugadores restantes en la partida?
